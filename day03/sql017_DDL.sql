...
/*
    ...
    IMAGE[이미지바이너리], SMALLINT[255까지의 정수], TEXT[2GB까지의 텍스트], NTEXT[유니코드 26]

    -- 가장 많이 쓰는 타입
    INT, CHAR, VARCHAR, DATETIME, DECIMAL, FLOAT, TEXT 외에는 잘 안 씀
*/
...
CREATE TABLE NewBook (
    ...
    publisher VARCHAR(20),
    price INT,
    PRIMARY KEY(bookid, bookname) -- 기본키를 두개 이상
);
...
ALTER TABLE MyBook ADD isbn VARCAHR(13);
